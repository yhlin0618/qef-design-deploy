...
#####
#P07_D04_05
# DERIVATION: CBZ Poisson Parameter Calculation (Wrapper)
# VERSION: 1.1
# PLATFORM: cbz
# GROUP: D04
# SEQUENCE: 05
# PURPOSE: Wrapper entry point for Poisson calculation (delegates to cbz_D04_02.R)
...
#' @title CBZ D04_05 Wrapper - Poisson Parameter Calculation
...
# ==============================================================================
tryCatch({
  message("Running cbz_D04_02.R via wrapper (D04_05)...")
...
message(sprintf("Script: %s", "cbz_D04_05.R"))
