#!/usr/bin/env Rscript
#####
# DERIVATION: D01_02 Customer Features + DNA (AMZ)
# VERSION: 3.0
# PLATFORM: amz
# GROUP: D01
# SEQUENCE: 02
...
#           processed_data.df_amz_sales_by_customer_by_date
...
#' @title D01_02 Customer Features + DNA (AMZ)
#' @description Compute customer features and DNA via core function
#' @input_tables processed_data.df_amz_sales_by_customer, processed_data.df_amz_sales_by_customer_by_date
#' @output_tables processed_data.df_amz_customer_rfm, cleansed_data.df_dna_by_customer___cleansed
