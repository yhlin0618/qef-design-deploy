...
> **⚠️ SUPERSEDED (2025-12-24)**
>
> This NSQL `SYNC GIT` directive has been **superseded by Claude Code slash commands**.
>
> **New Implementation**: `global_scripts/.claude/commands/`
>
> | NSQL Directive | New Slash Command |
> |----------------|-------------------|
> | `SYNC GIT` | `/git-sync` |
> | Pull only | `/subrepo-pull` |
> | Push only | `/subrepo-push` |
> | Commit | `/git-commit` |
> | Status | `/git-status` |
>
> **Why the change?**
> - Slash commands don't require R environment
> - Simpler UX: `/git-sync` instead of NSQL syntax
> - Full subrepo support (git subrepo pull/push)
> - Auto-distributed via subrepo to all projects
>
